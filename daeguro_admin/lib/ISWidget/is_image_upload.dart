...
class ISImageUpload extends StatefulWidget {
  ISImageUpload({
    this.fileList,
    this.onUpload,
  ...
  @override
  ISImageUploadState createState() => ISImageUploadState();
}

class ISImageUploadState extends State<ISImageUpload> {
