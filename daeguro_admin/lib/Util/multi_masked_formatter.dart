...
class MultiMaskedTextInputFormatter extends TextInputFormatter {
  ...
  TextEditingValue formatEditUpdate(
    ...
    if (ValidateString(newText) == true)
      return TextEditingValue(text: oldText, selection: TextSelection.collapsed(offset: oldText.length,),);
  ...
  bool ValidateString(String value){
    //RegExp regExp = new RegExp(r'(^[a-zA-Z]*$)');// 영문만
    RegExp regExp = new RegExp(r'[a-zA-Zㄱ-ㅎ|ㅏ-ㅣ가-힣|$@!%*#?~^<>\\(\\)./&+=;""]');//영문+한글+특수
