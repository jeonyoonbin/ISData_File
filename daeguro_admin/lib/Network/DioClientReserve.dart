...
class DioClientReserve {
  ...
  Future<dynamic> deleteReviewImage(String value, String ccCode, String shopCode, String seq) async {
    Response result = null;

    try {
      result = await _dio.delete(value, data: {"ccCode": ccCode , "shopCode": shopCode , "seq": seq, "userId": GetStorage().read('logininfo')['uCode']});
    } catch (e) {
      print('Error deleting: $e');
    }
