...
@JsonSerializable()
class taxiNoticeDetailModel {
  taxiNoticeDetailModel();
  ...
  factory taxiNoticeDetailModel.fromJson(Map<String,dynamic> json) => _$ModelFromJson(json);
  Map<String, dynamic> toJson() => _$ModelToJson(this);
}

taxiNoticeDetailModel _$ModelFromJson(Map<String, dynamic> json) {
  return taxiNoticeDetailModel()
    ..selected = json['selected'] as bool
    ..noticeSeq = json['noticeSeq'] as String
    ..noticeGbn = json['noticeGbn'] as String
    ..noticeService = json['noticeService'] as String
...
Map<String, dynamic> _$ModelToJson(taxiNoticeDetailModel instance) => <String, dynamic>{
