...
class taxiNoticeEditModel {
  ...
  factory taxiNoticeEditModel.fromJson(Map<String,dynamic> json) => _$ModelFromJson(json);
  Map<String, dynamic> toJson() => _$ModelToJson(this);
}

taxiNoticeEditModel _$ModelFromJson(Map<String, dynamic> json) {
  return taxiNoticeEditModel()
...
Map<String, dynamic> _$ModelToJson(taxiNoticeEditModel instance) => <String, dynamic>{
