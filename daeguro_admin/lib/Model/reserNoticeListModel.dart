...
@JsonSerializable()
class ResernoticeListModel {
  ResernoticeListModel();
  ...
  factory ResernoticeListModel.fromJson(Map<String,dynamic> json) => _$ModelFromJson(json);
  Map<String, dynamic> toJson() => _$ModelToJson(this);
}

ResernoticeListModel _$ModelFromJson(Map<String, dynamic> json) {
  return ResernoticeListModel()
...
Map<String, dynamic> _$ModelToJson(ResernoticeListModel instance) => <String, dynamic>{
