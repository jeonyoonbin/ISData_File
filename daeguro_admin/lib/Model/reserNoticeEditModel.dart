...
@JsonSerializable()
class ReserNoticeEditModel {
  ReserNoticeEditModel();
  ...
  factory ReserNoticeEditModel.fromJson(Map<String,dynamic> json) => _$ModelFromJson(json);
  Map<String, dynamic> toJson() => _$ModelToJson(this);
}

ReserNoticeEditModel _$ModelFromJson(Map<String, dynamic> json) {
  return ReserNoticeEditModel()
...
Map<String, dynamic> _$ModelToJson(ReserNoticeEditModel instance) => <String, dynamic>{
