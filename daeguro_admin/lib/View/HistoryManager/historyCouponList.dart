...
class HistoryCouponList extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return HistoryCouponListState();
  }
}

class HistoryCouponListState extends State {
  ...
  loadData() async {
    ...
    await CouponController.to.getHistoryData().then((value) {
      if (this.mounted) {
        if (value == null) {
