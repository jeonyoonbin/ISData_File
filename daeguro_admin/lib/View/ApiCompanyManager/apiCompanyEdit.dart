...
class ApiCompanyEdit extends StatefulWidget {
  final ApiCompanyDModel sData;
  final String seq;

  //final ShopBasicInfo sData;

  const ApiCompanyEdit({Key key, this.sData, this.seq})
      : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return ApiCompanyEditState();
  }
}

class ApiCompanyEditState extends State<ApiCompanyEdit> {
  ...
  Widget build(BuildContext context) {
    ...
    ButtonBar buttonBar = ButtonBar(
      ...
      children: <Widget>[
        if (AuthUtil.isAuthEditEnabled('39') == true)
        ISButton(
          label: '저장',
          iconData: Icons.save,
          onPressed: () async {
            ...
            ApiCompanyController.to.putData(formData.toJson(), context);
