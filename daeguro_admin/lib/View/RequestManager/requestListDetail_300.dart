...
class RestListDetail_300 extends StatefulWidget {
  final String seq;

  //final ShopInfo sData;
  const RestListDetail_300({Key key, this.seq}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return RestListDetail_300State();
  }
}

class RestListDetail_300State extends State<RestListDetail_300> with SingleTickerProviderStateMixin {
                  ...
                  children: [
                    ...
                    InkWell(
                      ...
                      child: image_url == null
                          ...
                          : Image.network(
                        image_url.replaceAll('https://admin.daeguro.co.kr', '').toString(),
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                Visibility(
                                  visible: afterImageURL == 'null' ? false : true,
                                  child: InkWell(
                                    child: Container(
                                        width: 30,
                                        child: Icon(
                                    ...
                                    onTap: () async {
                                      _launchInBrowser(afterImageURL);
                                    },
                                  ),
                                ),
                                Visibility(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      showConfirm(afterImageURL.replaceAll('https://ceo.daeguro.co.kr/RequestServiceImage/', '/request-images/').toString());
                                    },
                                  ),
                                ),
                              ],
                        ...
                        InkWell(
                            child: SizedBox(
                              ...
                              child: afterImageURL == null
                                  ? Image.asset('assets/empty_menu.png')
                                  : Image.network(
                                afterImageURL.replaceAll('https://ceo.daeguro.co.kr/RequestServiceImage/', '/request-images/').toString(),
                                gaplessPlayback: true,
                                errorBuilder: (context, error, stackTrace) {
                                  return Image.asset('assets/empty_menu.png');
                                },
