...
import 'package:daeguro_admin_app/Model/user/userHistoryModel.dart';
...
class UserHistory extends StatefulWidget {
  ...
  const UserHistory({Key key, this.shopCode}) : super(key: key);
...
class UserHistoryState extends State<UserHistory> with SingleTickerProviderStateMixin {
  final GlobalKey<FormState> formKey = GlobalKey<FormState>();

  final List<UserHistoryModel> dataHistoryList = <UserHistoryModel>[];
