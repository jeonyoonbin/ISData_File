...
import 'package:daeguro_admin_app/View/TaxiManager/taxiFAQEdit.dart';
import 'package:daeguro_admin_app/View/TaxiManager/taxiFAQRegist.dart';
...
class TempModel {
  ...
  bool selected = false;
  String RNUM = '1';
  String shopName ='호출/결제';
  String shopCd = 'O';
  String bussType = '현금으로 결제 할 수 있나요?'; //사업자유형
  String bussTaxType = '최윤오'; //사업자유형
  String bussOwner = '2022-03-03';
}
class TaxiFAQList extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return TaxiFAQListState();
  }
}

class TaxiFAQListState extends State {
          ...
          ISDatatable(
            ...
            rows: dataList.map((item) {
              return DataRow(cells: [
                ...
                DataCell(Align(child: SelectableText(item.shopCd.toString() ?? '--', style: TextStyle(color: Colors.black), showCursor: true,), alignment: Alignment.center)),
            ...
            columns: <DataColumn>[
              ...
              DataColumn(label: Expanded(child: Text('분류', textAlign: TextAlign.center)),),
              DataColumn(label: Expanded(child: Text('게시유무', textAlign: TextAlign.center)),),
              DataColumn(label: Expanded(child: Text('질문', textAlign: TextAlign.center)),),
              DataColumn(label: Expanded(child: Text('작성자', textAlign: TextAlign.center)),),
              DataColumn(label: Expanded(child: Text('작성일', textAlign: TextAlign.center)),),
