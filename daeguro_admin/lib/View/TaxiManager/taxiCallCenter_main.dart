...
import 'package:daeguro_admin_app/View/TaxiManager/taxiCallCenterList.dart';
import 'package:daeguro_admin_app/View/Today/header.dart';
import 'package:daeguro_admin_app/constants/constant.dart';

import 'package:flutter/material.dart';

class TaxiCallCenterMain extends StatelessWidget {
  @override
            ...
            Row(
              ...
              children: [
                Expanded(
                  child: Column(
                    children: [
                      TaxiCallCenterList(),//텍시 지점(콜센터) 관리 클래스 생성후, 변경 필요
                    ],
                  ),
                ),
              ],
