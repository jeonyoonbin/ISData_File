...
class TaxiCallCenterHistoryInfo extends StatefulWidget {
  ...
  const TaxiCallCenterHistoryInfo({Key key, this.stream, this.callback, this.selectBox_ccCode, this.height}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return TaxiCallCenterHistoryInfoState();
  }
}

enum RadioGbn { gbn1, gbn2 }

class TaxiCallCenterHistoryInfoState extends State<TaxiCallCenterHistoryInfo> with SingleTickerProviderStateMixin, AutomaticKeepAliveClientMixin {
  ...
  void initState() {
    ...
    termsDataList.add(new SelectOptionVO(value: '1', label: '변경사항11', label2: '2022-04-01'));
    termsDataList.add(new SelectOptionVO(value: '2', label: '변경사항222', label2: '2022-04-03'));
    termsDataList.add(new SelectOptionVO(value: '3', label: '변경사항33333', label2: '2022-04-07'));
