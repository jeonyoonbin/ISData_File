...
import 'package:daeguro_admin_app/View/TaxiManager/taxiNoticeEdit.dart';
import 'package:daeguro_admin_app/View/TaxiManager/taxiNoticeRegist.dart';
...
class TaxiNoticeList extends StatefulWidget {
  @override
...
class NoticeListState extends State {
  ...
  String _noticeService = '1';//서비스선택 항목 드롭박스
  ...
  _edit({String noticeSeq}) async {
    taxiNoticeDetailModel editData = null;

    await NoticeController.to.getDetailData(noticeSeq.toString()).then((value) {
      if (value == null) {
        ISAlert(context, '정상조회가 되지 않았습니다. \n\n관리자에게 문의 바랍니다');
      } else {
        editData = taxiNoticeDetailModel.fromJson(value);
      }
    });
    ...
    showDialog(
      ...
      builder: (BuildContext context) => Dialog(
        child: TaxiNoticeEdit(sData: editData),
      ),
    ).then((v) async {
      if (v != null) {
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      //   label: '서비스구분',
                      //   width: 140,
                      //   value: _noticeService,
                      //   onChange: (value) {
                      //     setState(() {
                      //       _noticeService = value;
                      //       _currentPage = 1;
                      //       _query();
                      //     });
                      //   },
                      //   item: [
                      //     DropdownMenuItem(value: '1', child: Text('공통(전체)'),),
                      //     DropdownMenuItem(value: '2', child: Text('주문'),),
                      //     DropdownMenuItem(value: '3', child: Text('택시'),),
                      //     DropdownMenuItem(value: '4', child: Text('꽃배달'),),
                      //     DropdownMenuItem(value: '5', child: Text('퀵'),),
                      //     DropdownMenuItem(value: '6', child: Text('대리'),),
        ...
        children: <Widget>[
          ...
          ISDatatable(
            ...
            columns: <DataColumn>[
              ...
              // DataColumn(label: Expanded(child: Text('서비스', textAlign: TextAlign.center)),),
