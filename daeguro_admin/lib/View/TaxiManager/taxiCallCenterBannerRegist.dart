...
class taxiCallCenterBannerRegist extends StatefulWidget {

  const taxiCallCenterBannerRegist({Key key}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return taxiCallCenterBannerRegistState();
  }
}

enum RadioGbn { gbn1, gbn2 }

class taxiCallCenterBannerRegistState extends State<taxiCallCenterBannerRegist> {
