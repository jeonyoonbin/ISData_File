...
import 'package:daeguro_admin_app/View/TaxiManager/taxiRegi_history.dart';
...
class TaxiRegiEdit extends StatefulWidget {
  final String shopCd;
  const TaxiRegiEdit({Key key, this.shopCd}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return TaxiRegiEditState();
  }
}

class TaxiRegiEditState extends State<TaxiRegiEdit> {
