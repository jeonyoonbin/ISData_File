...
import 'package:daeguro_admin_app/View/TaxiManager/taxiOrderCustomerTestimonials.dart';
import 'package:daeguro_admin_app/View/TaxiManager/taxiOrderDispatchInterval.dart';
import 'package:daeguro_admin_app/View/TaxiManager/taxiOrderHistoryInfo.dart';
import 'package:daeguro_admin_app/View/TaxiManager/taxiOrderInfo.dart';
import 'package:daeguro_admin_app/View/TaxiManager/taxiOrderPaymentInfo.dart';
...
class TaxiOrderList extends StatefulWidget {
  final String shopName;
  final double popWidth;
  final double popHeight;

  const TaxiOrderList({key, this.shopName, this.popWidth, this.popHeight}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return TaxiOrderListState();
  }
}

class TaxiOrderListState extends State<TaxiOrderList> with SingleTickerProviderStateMixin {
  ...
  void setDetailViewData(String shopCd, String mCode, String ccCode, String apiComCode, String imageStatus, String calcYn, String shopInfoYn, String deliYn,
                ...
                child: Column(
                  children: [
                    ISDatatable(
                      ...
                      listWidth: widget.shopName == null ? 1110 : widget.popWidth,
                      ...
                      columns: <DataColumn>[
                        ...
                        DataColumn(
                          label: Expanded(child: SelectableText('오더번호', textAlign: TextAlign.center)),
                        ),
                        DataColumn(
                        ...
                        DataColumn(
                          label: Expanded(child: Text('고객정보', textAlign: TextAlign.center)),
                        ),
                        DataColumn(
                          label: Expanded(child: Text('출발지\n/도착지', textAlign: TextAlign.center)),
                        ),
                        DataColumn(
                          label: Expanded(child: Text('운행시작\n/종료', textAlign: TextAlign.center)),
                        ),
                        DataColumn(
                            label: Expanded(
                                child: Text(
          ...
          children: [
            ...
            Container(
              ...
              child: TabBarView(physics: NeverScrollableScrollPhysics(), controller: _nestedTabController, children: <Widget>[
                ...
                AuthUtil.isAuthReadEnabled('95') == true
                    ? TaxiOrderPayMentInfo(
                    stream: streamControllerCalcInfo.stream,
                    callback: detailCallback,
                    selectBox_operator: selectBox_operatorBasicInfo,
                    selectBox_salesman: selectBox_salesmanBasicInfo,
                    selectBox_ccCode: selectBox_ccCodeBasicInfo,
                ...
                AuthUtil.isAuthReadEnabled('100') == true
                    ? TaxiOrderCustomerTestimonials(
                    stream: streamControllerDeliTip.stream,
                    callback: detailCallback,
                    height: widget.shopName == null ? (MediaQuery.of(context).size.height - 321) : widget.popHeight - 206)
                    : Container(
                  child: Text('조회 권한이 없습니다.', style: TextStyle(color: Colors.black45)),
