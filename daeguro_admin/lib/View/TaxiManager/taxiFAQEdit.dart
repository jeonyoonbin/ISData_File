...
class taxiFAQEdit extends StatefulWidget {
  final String name;

  const taxiFAQEdit({Key key, this.name}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return taxiFAQEditState();
  }
}

class taxiFAQEditState extends State<taxiFAQEdit> {
    ...
    ButtonBar buttonBar = ButtonBar(
      ...
      children: <Widget>[
        ...
        ISButton(
          ...
          onPressed: () {
            ISConfirm(context, 'FAQ 삭제', '삭제 하시겠습니까?', (context) async {
