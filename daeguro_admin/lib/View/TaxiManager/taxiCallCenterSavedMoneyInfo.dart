...
class TaxiCallCenterSavedMoneyInfo extends StatefulWidget {
  ...
  const TaxiCallCenterSavedMoneyInfo({Key key, this.stream, this.callback, this.selectBox_ccCode, this.height}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return TaxiCallCenterSavedMoneyInfoState();
  }
}

class TaxiCallCenterSavedMoneyInfoState extends State<TaxiCallCenterSavedMoneyInfo> with SingleTickerProviderStateMixin, AutomaticKeepAliveClientMixin {
  ...
  List<SelectOptionVO> selectBox_gbn1 = [
    new SelectOptionVO(value: '00', label: '전체'),
    new SelectOptionVO(value: '10', label: '입금'),
    new SelectOptionVO(value: '20', label: '출금')
  ];

  List<SelectOptionVO> selectBox_gbn2 = [
    new SelectOptionVO(value: '00', label: '전체'),
    new SelectOptionVO(value: '10', label: '적립금이체'),
    new SelectOptionVO(value: '20', label: '계좌이체'),
    new SelectOptionVO(value: '30', label: '오더금액'),
    new SelectOptionVO(value: '40', label: '수수료'),
    new SelectOptionVO(value: '50', label: '주선료'),
    new SelectOptionVO(value: '60', label: '공유수수료')
  ];
