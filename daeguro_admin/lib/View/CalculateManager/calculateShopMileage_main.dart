...
import 'package:daeguro_admin_app/View/CalculateManager/calculateShopMileage.dart';
import 'package:daeguro_admin_app/View/Today/header.dart';
import 'package:daeguro_admin_app/constants/constant.dart';

import 'package:flutter/material.dart';

class CalculateShopMileageManager extends StatelessWidget {
  @override
    ...
    return SafeArea(
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            Header(title: "가맹점 적립금 관리"),
            //SizedBox(height: defaultHeightPadding),
            CalculateShopMileage(),
          ],
        ),
      ),
    );
