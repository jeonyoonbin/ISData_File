...
import 'package:daeguro_admin_app/View/CodeManager/codeCouponEdit.dart';
import 'package:daeguro_admin_app/View/CodeManager/codeCouponRegist.dart';
...
class CodeCouponListManager extends StatefulWidget {
  @override
  CodeCouponListManagerState createState() => CodeCouponListManagerState();
}

class CodeCouponListManagerState extends State<CodeCouponListManager> {
  ...
  loadData() async {
    ...
    await CodeController.to.getListData('COUPON_TYPE', _useGbn).then((value) {
      if (value == null) {
        ...
        value.forEach((e) {
          ...
          //print('CODE:${temp.CODE}, CODE_NAME:${temp.CODE_NM}, ETC_CODE_GBN4:${temp.ETC_CODE_GBN4}, ETC_CODE_GBN7:${temp.ETC_CODE_GBN7}');
        ...
        children: <Widget>[
          ...
          Row(
            children: [
              ...
              SizedBox(width: 8,),
              if (AuthUtil.isAuthCreateEnabled('43') == true)
              ISSearchButton(
                  label: '추가',
                  iconData: Icons.add,
                  onPressed: () => {
        ...
        children: <Widget>[
          ...
          ISDatatable(
            ...
            rows: dataList.map((item) {
              return DataRow(
                  cells: [
                        ...
                        child: Container(
                          ...
                          child: DropdownButton(
                            ...
                            onChanged: (value) async {
                              if (AuthUtil.isAuthEditEnabled('43') == false){
                    ...
                    DataCell(Align(child: SelectableText((item.ETC_AMT1 == null ? '' : Utils.getCashComma(item.ETC_AMT1.toString())), style: TextStyle(color: Colors.black, fontSize: 12), showCursor: true), alignment: Alignment.centerRight)),
                        ...
                        child: InkWell(
                          ...
                          onTap: () {
                            showDialog(
                              context: context,
                              builder: (BuildContext context) => Dialog(
                                child: CodeCouponEdit(sData: item),
                              ),
                            ).then((v) async {
                              if (v != null) {
                                await Future.delayed(Duration(milliseconds: 500), (){
            ...
            columns: <DataColumn>[
              ...
              DataColumn(label: Expanded(child: Text('발행기간', textAlign: TextAlign.right)),),
