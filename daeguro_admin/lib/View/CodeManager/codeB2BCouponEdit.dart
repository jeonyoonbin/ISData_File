...
class CodeB2BCouponEdit extends StatefulWidget {
  final codeListModel sData;

  const CodeB2BCouponEdit({Key key, this.sData}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return CodeB2BCouponEditState();
  }
}

class CodeB2BCouponEditState extends State<CodeB2BCouponEdit> {
  ...
  Widget build(BuildContext context) {
    ...
    ButtonBar buttonBar = ButtonBar(
      ...
      children: <Widget>[
        if (AuthUtil.isAuthEditEnabled('44') == true)
        ISButton(
          label: '수정',
          iconData: Icons.save,
          onPressed: () {
        ...
        if (AuthUtil.isAuthDeleteEnabled('44') == true)
        ISButton(
          label: '삭제',
